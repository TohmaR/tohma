...
export default function ProjectsDesktop (){
    ...
    return( 
      <div className="container" id="projects">
        <section className="panel projects1">
          <motion.div 
        ...
        <section className="panel projects2">
          <div className="projects__number"><span>.</span>002</div>
          <div className="projects__photo">
            <Link className="projects__link" to="/Sneakmart" refresh="true">
              <img src={PresentationSneakmart}/>
            </Link>
          </div>
          <div className="projects__photo__box"></div>
          <motion.h2 
        ...
        <section className="panel projects3">
        <div className="projects__number"><span>.</span>003</div>
          <div className="projects__photo">
            <Link className="projects__link" to="/HDMI" refresh="true">
              <img src={PresentationHDMI}/>
            </Link>
          </div>
          <div className="projects__photo__box"></div>
          <motion.h2 
        ...
        <section className="panel projects4">
