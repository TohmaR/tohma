        ...
        <div className="contact" id="contact">
            ...
            {isTabletOrMobile &&
                <div className="contact__social">
                    <ul>
                        <li> 
                            <a data-cursor-stick="#stick-social" data-cursor-size="55px" data-cursor-color="#87ea40" href="https://github.com/TohmaR">
                                <svg id="stick-social" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30" width="40px" height="40px">
