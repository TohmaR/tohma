...
function LoadingPageDesktop() {
    ...
    useEffect(() => {
        const handleMouseMove = (event) => {
            if (animationsCompleted && window.scrollY === 0) {
                const svg = document.querySelector(".loadingPage svg");
                ...
                const rotateY = -percentX * 1.25; // Adjust tilt intensity here
                const rotateX = percentY * 1.25; // Adjust tilt intensity here
    ...
    useEffect(() => {
        ...
        timelines.push(animateMorph('.morph1__initial', [
            ...
            ["to", { delay: 0.15, morphSVG : '.morph1__4'}],
            ["to", { delay: 0.15, morphSVG : '.morph1__8'}],
            ["to", { delay: 0.15, morphSVG : '.morph1__9'}],
        ...
        timelines.push(animateMorph('.morph2__initial', [
            ...
            ["to", { delay: 0.15, morphSVG : '.morph2__5'}],
            ["to", { delay: 0.15 , morphSVG : '.morph2__°'}],
            ["to", { delay: 0.15, morphSVG : '.morph2__9'}],
        ...
        timelines.push(animateMorph('.morph3__initial', [
            ...
            ["to", { delay: 0.15, morphSVG : '.morph3__initial'}],
            ["to", { delay: 0.15, morphSVG : '.morph3__separator'}],
            ["to", { delay: 0.15, morphSVG : '.morph3__initial'}],
        ...
        timelines.push(animateMorph('.morph4__initial', [
            ...
            ["to", { delay: 0.15, morphSVG : '.morph4__initial'}],
            ["to", { delay: 0.15 , morphSVG : '.morph4__°'}],
            ["to", { delay: 0.15, morphSVG : '.morph4__initial'}],
        ...
        timelines.push(animateMorph('.morph5__initial', [
            ...
            ["to", { delay: 0.15, morphSVG : '.morph5__initial'}],
            ["to", { delay: 0.15, morphSVG : '.morph5__5'}],
            ["to", { delay: 0.15, morphSVG : '.morph5__initial'}],
            ["to", { duration: 0.6, delay : 0.6, morphSVG : '.morph5__A'}],
            ["to", { delay: -0.6, duration : 0.5, y : -70}], 
        ], 1));
        
        const tlBackground = gsap.timeline({ delay: 4.2 });
