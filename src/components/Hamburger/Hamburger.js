...
function Hamburger(){
    ...
    const scrollOverflowDelay = 8550;
    const scrollTargetDelay = 8600;
    ...
    const navigationLinks = [
        ...
        { text: 'CV', target: 'cv', pdf: PDF }, // Ajout d'un attribut PDF
    ];
    ...
    return(
        <div>
            ...
            <div className="hamburger__nav">
                <ul>
                    {/* Mapper les liens de navigation */}
                ...
                <div className="hamburger__social" ref={hamburgerSocialRef}>
                    <ul>
                        {/* Mapper les icônes de médias sociaux */}
...
//             });
//             menuTimeline.current.to('.logoLetter1', { duration: 0.1, delay: -0.8, opacity : 1})
//             menuTimeline.current.to('.logoLetter2', { duration: 0.1, delay: -0.7, opacity : 1})
//             menuTimeline.current.to('.logoLetter3', { duration: 0.1, delay: -0.6, opacity : 1})
//             menuTimeline.current.to('.logoLetter4', { duration: 0.1, delay: -0.5, opacity : 1})
//             menuTimeline.current.to('.logoLetter5', { duration: 0.1, delay: -0.4, opacity : 1})
//             menuTimeline.current.to('.hamburger__social', { duration: 0.4, delay: -0.3, opacity : 1, y: 0})

//             if(toggleMenu != null)
//             {  
//                 toggleMenu ? (document.body.style.overflowY = "hidden") : (document.body.style.overflowY = "scroll");
