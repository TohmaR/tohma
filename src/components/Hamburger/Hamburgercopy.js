        ...
        <div>
            ...
            <div className="hamburger__menu">
                <div className="hamburger__nav">
                    <ul>
                        <NavLink to="/home" spy={true} smooth={true} offset={50} duration={1000} onClick={() => setToggleMenu(!toggleMenu)}><div className="hamburger__text--container"><li className="hamburger__nav--text">Home</li></div></NavLink>
                        <NavLink to="projects" spy={true} smooth={true} offset={50} duration={500} onClick={() => setToggleMenu(!toggleMenu)}><div className="hamburger__text--container"><li className="hamburger__nav--text">Projects</li></div></NavLink>
                        <NavLink to="contact" spy={true} smooth={true} offset={50} duration={1000} onClick={() => setToggleMenu(!toggleMenu)}><div className="hamburger__text--container"><li className="hamburger__nav--text">Contact</li></div></NavLink>
                        <a href={PDF} target = "_blank"><div className="hamburger__text--container"><li className="hamburger__nav--text">CV</li></div></a>
                    </ul>
                </div>
