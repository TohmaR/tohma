...
import VideoDesktop from "../../assets/image/JeanProuve/prout.mp4";
...
import Responsive from "../../assets/image/JeanProuve/responsive.jpg";
    ...
    return(
        <div className="project">
            ...
            <div className="project__container">
                ...
                <AnimatedTitle title={"Prouvé"} className="project__title" />
                <motion.div 
