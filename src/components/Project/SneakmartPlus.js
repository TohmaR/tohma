...
import VideoDesktop from "../../assets/image/Sneakmart+/sneakmart+VideoDesktop.mp4";
import VideoMobile from "../../assets/image/Sneakmart+/sneakmart+VideoMobile.mp4";
    ...
    return(
        <div className="project">
            ...
            <div className="project__container">
                ...
                <AnimatedTitle title={"Sneakmart+"} className="project__title" />
                <motion.div 
                    ...
                    <Link to="/Sneakmart">
                        <div className="project__next">
                            <div className="project__next--container">
                                ...
                                <AnimatedTitle title={"Sneakmart"} className="project__next--title" />
                            </div>
