  ...
  const socialIcons = [
    {
      ...
      svg: (
        <svg id="stick-social" viewBox="0 0 30 30" width="1.8229166666666667vw" height="3.7593984962406015vh">
